...
\subsection{Namings}
Here we list all namings which will be used in this paper. Let $d\in \N$, $q\in \{0,\dots,d\}$ and $r\in [0,\infty)$. 
\begin{flalign*}
...
If we choose a simple convex set such as $K=B_r$ then choosing random $K$-isotropic lines becomes a very intuitive and easy realizable task as the following lemma shows.
