...
\begin{flalign*}
	d_f = \frac{d^2 + 1}{d+1}
\end{flalign*}
in $\Z^d$ which seems to agree fairly well with simulations ($\cite{lawler}$ page 83). We will proof in the following an a.s. lower bound for the fractal dimension of extern DLA. We will first prepare everything to able to use theorem \ref{iatheorem}. 
