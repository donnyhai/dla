...
\begin{proof}
	...
	\begin{flalign*}
		Z_n := \{[z] := (z_1, \dots, z_n)\in (\Z^2)^n \ |\ z_1\in \tilde B_n, z_i\in N(z_{i-1}) \text{ for } i\geq 2\text{ and }z_i\neq z_j \text{ for }i\neq j\}. 
	\end{flalign*}
	...
	\begin{flalign*}
		\PP(W_n)\leq \sum_{[z]\in Z_n} \PP(W_n([z])) \leq c_2n3^{n-1} \frac{1}{a} (e^2a)^{n} = \frac{c_2}{3a}  n(3e^2a)^{n} \quad \text{ for all } n>N
	\end{flalign*} 
	and finally
	\begin{flalign*}
		\sum_{n>N} \PP(W_n) \leq \sum_{n>N} \frac{c_2}{3\beta c_1}  n(3e^2\beta c_1)^{n} =: r_\beta. 
	\end{flalign*}
