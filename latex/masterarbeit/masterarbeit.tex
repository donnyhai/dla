...
\begin{flalign*}
	...
	&B_r := B_2(0,r) \\
	&\G,\quad  \text{the set of lines in the plane}\\
	&SO_d := \{\nu \in \R^{d\times d}\ |\ \nu \nu^\top = I_d \text{ and } \det \nu = 1\}\\
	&SO_2 := \{\nu_\beta := e^{i\beta} \in \C\ |\ \beta\in [0,2\pi)\} \\
	&G_d := \{\varphi: \R^d \to \R^d, x\mapsto \nu x+b\ |\ \nu \in SO_d\text{ and }b\in \R^d\},\quad  \text{Euclidean motions} \\
...
\begin{remark} \label{trivialboundary2}
	...
	\begin{flalign*}
		L \leq \lim_{n\to\infty} \frac{\ln(n)}{\ln(cn^{\frac{1}{d}})} = d.
	\end{flalign*}
